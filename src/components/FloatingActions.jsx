...
export default function FloatingActions() {
    return (
        <div className="fixed bottom-8 right-8 z-50 flex gap-4 p-2 bg-white/80 backdrop-blur-xl rounded-full border border-white/40 shadow-2xl ring-1 ring-black/5 hover:scale-105 transition-transform duration-300">
